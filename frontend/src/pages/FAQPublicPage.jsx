    ...
    <>
      ...
      <div className="rounded-2xl bg-[#f9f9f9] min-h-screen flex flex-col" style={{ paddingTop: "2rem" }}>
        <div className="flex-1 w-full max-w-[1440px] mx-auto px-4 sm:px-6 md:px-15 py-4 sm:py-8 md:py-12 flex flex-col justify-start">
          <div className="text-center sm:text-left mb-5 sm:mb-8 faq-fade">
          ...
          <div className="bg-white rounded-2xl shadow-md p-4 sm:p-6 md:p-8 w-full box-border faq-fade delay-1">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-black mt-6 sm:mt-8 mb-4 sm:mb-6 faq-fade">
